...
public class IocJavaConfig {
	...
	/*
	 * 빈 메소드로 등록 메소드 : 스프링 빈으로 만들 객체를 반환하는 메소드 생성 메소드에 @Bean 어노테이션 적용
	 * 
	 * @Bean어노테이션에 별다른 옵션을 적용하지 않으면 생성된 스프링 빈의 이름은 메소드 이름으로 적용된다.(@Bean
	 * 어노테이션의name속성을 통해 스프링 빈 이름 설정가능
	 */
